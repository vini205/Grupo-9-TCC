...
<h1 class="w3-center w3-teal w3-round-large w3-margin">Questões </h1>
     ...
     <form action='Action.php' class='w3-border w3-content w3-margin w3-padding' method='post' >
    ...
    ?>
        <button name="btnEnviarResposta" class="w3-button w3-green" >Enviar Respostas</button>
    </form>
        </div>
